...
const MobileUpload: React.FC<MobileUploadProps> = ({ uploadId }) => {
  ...
  const saveApplicationToSupabase = async (applicationData: any, resumeFile?: File) => {
    try {
      ...
      // For mobile QR upload, we need to get job info from somewhere
      // Since this is a generic mobile upload, we'll use a default job or create a placeholder
      // In a real implementation, the QR code would contain job information
